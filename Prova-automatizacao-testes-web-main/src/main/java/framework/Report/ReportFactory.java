...
public class ReportFactory {
	...
	public static final String PATH_REPORT = System.getProperty("user.dir") 
			+ File.separator + "Report" + File.separator + "Report_" + DateTime.getDateTimeFormatReport();
	...
	public static void configReportExtent() {
		...
		extentSparkReporter = new ExtentSparkReporter(PATH_REPORT + File.separator + "Report_Execucao_" + 
		DateTime.getDateTimeFormatReport() + ".html");
		extentSparkReporter.config().setDocumentTitle("Relatorio Automacao de Testes Treinamento");
		extentSparkReporter.config().setReportName("Relatorio Execucao de Testes Automatizados");
