...
public class ReportFactory {
	...
	public static void configReportExtent() {
		...
		extentSparkReporter.config().setDocumentTitle("Relatorio de Execucao Automocao Capacitacao");// nome que aparece
																										// na aba do
																										// navegador
		extentSparkReporter.config().setReportName("Relatorio de Execução de Testes");
		...
		extentSparkReporter.config().setJs(
				"$('.nav-logo').html('<img src=\\\"https://imgur.com/HkrrWKH.png\\\" class=\\\"banri-logo\\\"/>');");
